 ...
 * 
 */
@WebServiceClient(name = "TestWebService", targetNamespace = "http://dhbw.de/vs/jaxws/", wsdlLocation = "http://localhost:8888/testservice/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TESTWEBSERVICE_QNAME = new QName("http://dhbw.de/vs/jaxws/", "TestWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/testservice/?wsdl");
    ...
    public DemoService getDemoServicePort() {
        return super.getPort(new QName("http://dhbw.de/vs/jaxws/", "DemoServicePort"), DemoService.class);
    }
    ...
    public DemoService getDemoServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dhbw.de/vs/jaxws/", "DemoServicePort"), DemoService.class, features);
    }
